// Dummy de Pachangas (fútbol sala) — versión con cromos 3D y rarezas
// position: "CAMPO" | "PORTERO"
// value: rating del cromo (0-100) — no es dinero
// rarity: "gold" | "silver" | "bronze"
// photo: ruta en /public/players/*.jpg (añade tus fotos allí). Si falta, usa /apple-icon.png
// supply/supplyTotal: numeración tipo 609/1000 (estilo Sorare)
...
export const players = [
  { id: "1",  name: "Escuriola", position: "PORTERO", value: 96, totalPoints: 128, matchesPlayed: 12,
    ...
    photo: "/players/escuriola.jpg", nationality: "🇪🇸", age: 34, supply: 609, supplyTotal: 1000
  },
...
// --- Partidos y playerHistories (idéntico a la versión anterior) ---
